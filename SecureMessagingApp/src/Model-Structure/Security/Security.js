...
exports.getSecretKey = exports.storeSecretKey = exports.generateSecretKey = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, storeSecretKey(secretKey)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, SecureStore.setItemAsync('secretKey', secretKey)];
                case 1:
                    // Store the secret key in the device's secure storage
                    _a.sent();
                    return [2 /*return*/];
...
exports.storeSecretKey = storeSecretKey;
...
function getSecretKey() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, SecureStore.getItemAsync('secretKey')];
                case 1: 
